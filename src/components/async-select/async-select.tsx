...
export interface AsyncSelectProps<TFieldValues extends FieldValues, TResponse>
  extends Omit<SelectProps<TFieldValues>, 'renderOption'> {
...
export function AsyncSelect<TFieldValues extends FieldValues, TResponse>({
  queryFn,
  name,
  parseOption,
  renderOption,
  ...rest
}: AsyncSelectProps<TFieldValues, TResponse>) {
